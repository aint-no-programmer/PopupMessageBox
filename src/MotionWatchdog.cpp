...
pmb::MotionWatchdog::MotionWatchdog(PopupWindowContainer* t_popupWindowContainer): QObject(t_popupWindowContainer)
{
...
void pmb::MotionWatchdog::keepTrack(PopupWindow* t_popupWindow) const 
{
...
void pmb::MotionWatchdog::clear()
{
	m_observables.clear();
}

void pmb::MotionWatchdog::onMotionStarted(QObject* t_popupWindow)
{
...
void pmb::MotionWatchdog::onMotionFinished(QObject* t_popupWindow)
{
	//remove from vector
